	...
	<div id="mainmenu">
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
				...
				array('label'=>'Nomina', 'url'=>array('nomina/admin')),
				array('label'=>'Cargos', 'url'=>array('cargos/admin')),
				array('label'=>'Empleados', 'url'=>array('empleados/admin')),
				array('label'=>'Hijos', 'url'=>array('hijos/admin')),
				array('label'=>'Obras', 'url'=>array('obras/admin')),
				array('label'=>'Tallas', 'url'=>array('tallas/admin')),
