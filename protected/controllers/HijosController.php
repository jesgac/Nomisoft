...
class HijosController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Hijos');
	...
	{
		$model=new Hijos('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Hijos']))
			$model->attributes=$_GET['Hijos'];
	 ...
	 * @return Hijos the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Hijos::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Hijos $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='hijos-form')
		{
