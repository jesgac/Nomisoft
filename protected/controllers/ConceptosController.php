...
class ConceptosController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Conceptos');
	...
	{
		$model=new Conceptos('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Conceptos']))
			$model->attributes=$_GET['Conceptos'];
	 ...
	 * @param Conceptos $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='conceptos-form')
		{
