...
class DefaultController extends Controller
{
	...
	public $file_name;
	public $_path = null;
	public $back_temp_file = 'db_nomisoft_';
	...
	public function actionDelete($file = null)
	{
		...
		else throw new CHttpException(404, Yii::t('app', 'Archivo no encontrado'));
		$this->actionIndex();
	}
	...
	public function actionDownload($file = null)
	{
		...
		throw new CHttpException(404, Yii::t('app', 'Archivo no encontrado'));
	}
	...
	public function actionIndex()
	{
		...
		if ($list_files )
		{
			...
			foreach ( $list as $id=>$filename )
			{
				...
				$columns['create_time'] = date( "d-m-Y h:i a", filectime($path .$filename) );
				$dataArray[] = $columns;
			}
		}
