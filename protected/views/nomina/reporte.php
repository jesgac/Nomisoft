...
<body>
	<table border="1">
		...
		<?php 
		 ...
		 ?>
			<?php echo ($data->empleado->cod_banco!="") ? '<tr>' : '<tr bgcolor="yellow">' ?>
				<td><?php echo $data->obra->nombre_obra; ?></td>
				<td><?php echo $data->persona->nombre.' '.$data->persona->apellido; ?></td>
				<?php echo ($data->empleado->cod_banco!="") ? '<td class="right"  bgcolor="cyan">':'<td class="right"  bgcolor="yellow">'.number_format($data->cargo->sueldo, 2,',','.'); ?></td> <?php $t_sueldo += $data->cargo->sueldo; ?>
				...
				<?php echo ($data->empleado->cod_banco!="") ? '<td class="right"  bgcolor="cyan">':'<td class="right"  bgcolor="yellow">'. number_format($data->total_asig, 2,',','.'); ?></td> <?php $t_asig += $data->total_asig; ?>
				...
				<?php echo ($data->empleado->cod_banco!="") ? '<td class="right"  bgcolor="cyan">':'<td class="right"  bgcolor="yellow">'.number_format($data->total_deduc, 2,',','.'); ?></td> <?php $t_deducciones += $data->total_deduc ?>
