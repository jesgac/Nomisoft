...
INSERT INTO `personas` (`id`,`nombre`,`apellido`,`cedula`,`fecha_nac`,`lugar_nac`,`nacionalidad`,`sexo`,`direccion`,`telefono`,`email`) VALUES
('3','Mariangel','Arruebarrena Hernández','13850772','1979-04-21','Valle de la Pascua','V','F','Calle El Carmen Casa Nº 20. San Juan de los Morros. Estado Guárico','','mariangelarrue1510@gmail.com');
INSERT INTO `personas` (`id`,`nombre`,`apellido`,`cedula`,`fecha_nac`,`lugar_nac`,`nacionalidad`,`sexo`,`direccion`,`telefono`,`email`) VALUES
